...
public class DownloadButtonTest {
    ...
    public void setup() throws Exception{
        ...
        workspace.unzipFrom(DownloadButtonTest.class.getResourceAsStream("./maven-project1.zip"));
        job.setDefinition(
    ...
    @Test
    public void testDownloadButton3() throws IOException, SAXException{
    ...
    @Test
    public void testDownloadFunction3() throws IOException, SAXException{
        String url = "job/" + job.getName() + "/" + buildNumber + "/diffbuild/mavenPhaseDiffAction/?Build1="
                + buildNumber + "&Build2=" + buildNumber;
        HtmlPage page = jenkinsRule.createWebClient().goTo(url);
        String jscode = "jQuery(function ($){\n"
