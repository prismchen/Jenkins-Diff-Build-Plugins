...
public class LogParserWorkflowTest {
    ...
    public static void init() throws Exception {
        ...
        WorkflowJob job = jenkinsRule.jenkins.createProject(WorkflowJob.class,
                "logParserPublisherWorkflowStep");
        FilePath workspace = jenkinsRule.jenkins.getWorkspaceFor(job);
        workspace
                .unzipFrom(LogParserWorkflowTest.class.getResourceAsStream("./maven-project1.zip"));
        job.setDefinition(
    ...
    /**
     * Run a workflow job using {@link LogParserPublisher} and check for
     * success.
     */
    @Test
    ...
    /**
     * Run a workflow job using {@link LogParserPublisher} and check for number
     * of debug tags
     */
    @Test
