...
public class DiffBuildActionTest {
    ...
    public void setUp() throws Exception {
        ...
        workspace.unzipFrom(DiffBuildActionTest.class.getResourceAsStream("./maven-project1.zip"));
        job.setDefinition(
    ...
    public void testDoFillAllBuildItems1() throws Exception {
        DiffBuildAction.DescriptorImpl descriptor = (DiffBuildAction.DescriptorImpl) act
                .getDescriptor();
        ListBoxModel listBox = descriptor.doFillBuild1Items();
    ...
    public void testAllBuildDropdown() throws Exception {
        ...
        WebAssert.assertElementPresent(page, "Build1Select");
    }
