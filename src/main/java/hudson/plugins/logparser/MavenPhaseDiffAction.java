...
public class MavenPhaseDiffAction implements Action {
     ...
     * @throws IOException
     */
    public MavenPhaseDiffAction(Job<?, ?> job) throws IOException {
        int build1Num = Integer.parseInt(Stapler.getCurrentRequest().getParameter("Build1"));
        int build2Num = Integer.parseInt(Stapler.getCurrentRequest().getParameter("Build2"));
