...
public class DiffToHtmlUtils {
    ...
    private static String generateCommonItem(int build1, int build2, String key,
        ...
        StringBuilder sb = new StringBuilder();
        String buttonId = key.hashCode() + "_button";
        String collapsableId = String.valueOf(key.hashCode());
        sb.append(generateJS(buttonId, collapsableId, "#"));
        sb.append("<div>");
        sb.append("build " + build1 + " and build " + build2 + " share " + key);
        sb.append("</div>");
        sb.append(generateButton(buttonId, "collapse"));
        sb.append("<div id='" + collapsableId + "'>");
